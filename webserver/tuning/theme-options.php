...
array(
    ...
    array(
		"type" => "options_group_start",
		"name" =>  __("Layout Settings", 'engine') ),
        array(
			"type" => "radio",
			"name" => __("Content Layout", 'engine'),
			"id" => "dt_layout",
			"options" => array( __("Left Aligned", 'engine'), __("Centered", 'engine') ),
			"values" => array( "left", "centered" ),
			"desc" => __("Choose how you want your content to be displayed.", 'engine'),
			"default" => "left"
		),
    array(
		"type" => "options_group_end" ),
...
array(
	...
	array(
		"type" => "options_group_start",
		"name" =>  __("Welcome Message", 'engine') ),
		array(
			"type" => "textarea",
			"name" =>  __("Welcome Message", 'engine'),
			"id" => "dt_welcome_message",
			"desc" =>  __("Enter a homepage welcome message for your visitors.", 'engine'),
			"default" => "" ),
	array(
		"type" => "options_group_end"),
	...
	array(
		...
		array(
			"type" => "text",
			"name" => __("Featured Posts Heading", 'engine') ,
			"id" => "dt_slider_head",
			"desc" => __("Customize the heading for the homepage \"Featured Posts\" slider.", 'engine'),
			"default" => __("Featured", 'featured')
		),
		array(
			"type" => "radio",
